...
exports.default = {
    ...
    'endOfStream for empty stream': function endOfStreamForEmptyStream(test) {
        test.expect(1);
        // tests here
        var p = _charsBundle2.default.char(' ').optrep().thenRight(_numbersBundle2.default.numberLiteral);
    ...
    'get from stream numberLiteral 123': function getFromStreamNumberLiteral123(test) {
        test.expect(1);
        // tests here
        var p = _charsBundle2.default.char(' ').optrep().thenRight(_numbersBundle2.default.numberLiteral);
