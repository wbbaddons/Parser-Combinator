...
var _charsBundle = require('./parsec/chars-bundle');

var _charsBundle2 = _interopRequireDefault(_charsBundle);

var _numbersBundle = require('./parsec/numbers-bundle');
...
exports.default = {
  F: _flowBundle2.default,
  C: _charsBundle2.default,
  N: _numbersBundle2.default
}; /*
    * Parsec
